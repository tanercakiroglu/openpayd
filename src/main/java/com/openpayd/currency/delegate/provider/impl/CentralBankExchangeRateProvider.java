...
import com.openpayd.currency.delegate.service.impl.ExchangeRateDelegateServiceImpl;

public class CentralBankExchangeRateProvider implements ExchangeRateProvider {

    @Override
    public ExchangeRateDelegateService create() {
        return new ExchangeRateDelegateServiceImpl();
    }
}
